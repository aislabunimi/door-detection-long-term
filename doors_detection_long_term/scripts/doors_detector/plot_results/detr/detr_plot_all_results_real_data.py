...
for dataset, dataset_name in [('deep_doors_2', 'Deep Doors 2'), ('gibson', 'Our dataset'), ('gibson_deep_doors_2', 'Our dataset + Deep Doors 2')]:
    ...
    ax.bar(X, closed_doors[('AP', experiments[0])].tolist() + [closed_doors[('AP', experiments[0])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[closed_doors[('AP', experiments[0])].std(), closed_doors[('AP', experiments[0])].std()]]).T,width=0.15, label=labels[0])
    ax.bar(X + 0.15, closed_doors[('AP', experiments[1])].tolist() + [closed_doors[('AP', experiments[1])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[closed_doors[('AP', experiments[1])].std(), closed_doors[('AP', experiments[1])].std()]]).T,  width=0.15, label=labels[1])
    ax.bar(X + 0.30, closed_doors[('AP', experiments[2])].tolist() + [closed_doors[('AP', experiments[2])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[closed_doors[('AP', experiments[2])].std(), closed_doors[('AP', experiments[2])].std()]]).T, width=0.15, label=labels[2])
    ax.bar(X + 0.45, closed_doors[('AP', experiments[3])].tolist() + [closed_doors[('AP', experiments[3])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[closed_doors[('AP', experiments[3])].std(), closed_doors[('AP', experiments[3])].std()]]).T, width=0.15, label=labels[3])
    ax.bar(X + 0.60, closed_doors[('AP', experiments[4])].tolist() + [closed_doors[('AP', experiments[4])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[closed_doors[('AP', experiments[4])].std(), closed_doors[('AP', experiments[4])].std()]]).T, width=0.15, label=labels[4])
    ...
    X = np.arange(4)
    ax.bar(X, open_doors[('AP', experiments[0])].tolist() + [open_doors[('AP', experiments[0])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[open_doors[('AP', experiments[0])].std(), open_doors[('AP', experiments[0])].std()]]).T, width=0.15, label=labels[0])
    ax.bar(X + 0.15, open_doors[('AP', experiments[1])].tolist() + [open_doors[('AP', experiments[1])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[open_doors[('AP', experiments[1])].std(), open_doors[('AP', experiments[1])].std()]]).T,  width=0.15, label=labels[1])
    ax.bar(X + 0.30, open_doors[('AP', experiments[2])].tolist() + [open_doors[('AP', experiments[2])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[open_doors[('AP', experiments[2])].std(), open_doors[('AP', experiments[2])].std()]]).T, width=0.15, label=labels[2])
    ax.bar(X + 0.45, open_doors[('AP', experiments[3])].tolist() + [open_doors[('AP', experiments[3])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[open_doors[('AP', experiments[3])].std(), open_doors[('AP', experiments[3])].std()]]).T, width=0.15, label=labels[3])
    ax.bar(X + 0.60, open_doors[('AP', experiments[4])].tolist() + [open_doors[('AP', experiments[4])].mean()], yerr=np.array([[0, 0] for _ in range(3)] + [[open_doors[('AP', experiments[4])].std(), open_doors[('AP', experiments[4])].std()]]).T, width=0.15, label=labels[4])
