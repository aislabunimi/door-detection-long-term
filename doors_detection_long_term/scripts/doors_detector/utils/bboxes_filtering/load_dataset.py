...
train_dataset_bboxes = DataLoader(train_bboxes, batch_size=2, collate_fn=collate_fn_bboxes, num_workers=4, shuffle=True)
test_dataset_bboxes = DataLoader(test_bboxes, batch_size=2, collate_fn=collate_fn_bboxes, num_workers=4)
