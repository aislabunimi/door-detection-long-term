...
train, test, labels, _ = get_final_doors_dataset_real_data(folder_name='house_matteo', train_size=0.25)
...
model = YOLOv5Model(model_name=YOLOv5, n_labels=2, pretrained=True, dataset_name=FINAL_DOORS_DATASET, description=EXP_2_HOUSE_MATTEO_GIBSON_EPOCHS_GD_60_EPOCHS_QD_40_FINE_TUNE_15)
...
save_path = ('/home/antonazzi/Downloads/test_yolo_qd15')
