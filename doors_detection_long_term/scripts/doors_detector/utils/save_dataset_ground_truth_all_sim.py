...
path_abs = '/mnt/54685f13-5e79-4e84-b2a6-bf3a0eba4d7f/classifications/'
...
if __name__ == '__main__':
    ...
    for house in ['house_1', 'house_2', 'house_7', 'house_9', 'house_10', 'house_13', 'house_15', 'house_20', 'house_21', 'house_22']:
        # Create_folder
        path = path_abs + house
        ...
        train, test, labels, COLORS = get_final_doors_dataset(2, house.replace('_', ''), train_size=0.75, use_negatives=False)
