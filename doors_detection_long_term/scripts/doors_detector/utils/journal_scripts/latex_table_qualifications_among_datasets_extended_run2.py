...
# Extended metric
houses = pd.read_excel('./../../../results/faster_rcnn_complete_metric_real_data_run2.xlsx')
...
# YOLO
houses = pd.read_excel('./../../../results/yolov5_complete_metric_real_data_run2.xlsx')
...
# DETR
houses = pd.read_excel('./../../../results/detr_complete_metrics_real_data_run2.xlsx')
...
houses = pd.read_excel('./../../../results/faster_rcnn_ap_real_data_run2.xlsx')
...
# YOLO
houses = pd.read_excel('./../../../results/yolov5_ap_real_data_run2.xlsx')
houses['AP'] = houses['AP'].astype(np.float64)
houses['AP'] = houses['AP'].apply(lambda x: x*100).round()
houses = houses.loc[(houses['epochs_gd'] == 60) & ((houses['epochs_qd'] == 40) | (houses['epochs_qd'] == 60)) &
                    (houses['iou_threshold'] == iou_threshold) & (houses['confidence_threshold'] == confidence_threshold)]
...
# DETR
houses = pd.read_excel('./../../../results/detr_ap_real_data_run2.xlsx')
houses['AP'] = houses['AP'].astype(np.float64)
houses['AP'] = houses['AP'].apply(lambda x: x*100).round()
houses = houses.loc[(houses['epochs_gd'] == 60) & ((houses['epochs_qd'] == 40) | (houses['epochs_qd'] == 60)) &
                    (houses['iou_threshold'] == iou_threshold) & (houses['confidence_threshold'] == confidence_threshold)]
...
for house_number, house in enumerate(['floor4']):
