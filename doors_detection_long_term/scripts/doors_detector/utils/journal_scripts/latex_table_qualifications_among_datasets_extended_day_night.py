...
# Extended metric
houses = pd.read_excel('./../../../results/faster_rcnn_complete_metric_real_data_day_night.xlsx')
...
houses_faster.loc[houses_faster['house'] == 'floor4run2', 'house'] = 'floor4_run2'

# YOLO
houses = pd.read_excel('./../../../results/yolov5_complete_metric_real_data_day_night.xlsx')
...
houses_yolo.loc[houses_yolo['house'] == 'floor4run2', 'house'] = 'floor4_run2'

# DETR
houses = pd.read_excel('./../../../results/detr_complete_metrics_real_data_day_night.xlsx')
...
houses_detr.loc[houses_detr['house'] == 'floor4run2', 'house'] = 'floor4_run2'
...
houses = pd.read_excel('./../../../results/faster_rcnn_ap_real_data_day_night.xlsx')
...
# YOLO
houses = pd.read_excel('./../../../results/yolov5_ap_real_data_day_night.xlsx')
houses['AP'] = houses['AP'].astype(np.float64)
houses['AP'] = houses['AP'].apply(lambda x: x*100).round()
houses = houses.loc[(houses['epochs_gd'] == 60) & ((houses['epochs_qd'] == 40) | (houses['epochs_qd'] == 60)) &
                    (houses['iou_threshold'] == iou_threshold) & (houses['confidence_threshold'] == confidence_threshold)]
...
# DETR
houses = pd.read_excel('./../../../results/detr_ap_real_data_day_night.xlsx')
houses['AP'] = houses['AP'].astype(np.float64)
houses['AP'] = houses['AP'].apply(lambda x: x*100).round()
houses = houses.loc[(houses['epochs_gd'] == 60) & ((houses['epochs_qd'] == 40) | (houses['epochs_qd'] == 60)) &
                    (houses['iou_threshold'] == iou_threshold) & (houses['confidence_threshold'] == confidence_threshold)]
...
houses_detr_ap.loc[houses_detr_ap['house'] == 'floor4run2', 'house'] = 'floor4_run2'
...
for house_number, house in enumerate(['floor4_run2']):
