...
model_names = [(EXP_GENERAL_DETECTOR_FIXED_BACKBONE_GIBSON_40_EPOCHS, EXP_GENERAL_DETECTOR_FIXED_BACKBONE_GIBSON_60_EPOCHS),
               (EXP_GENERAL_DETECTOR_FIXED_BACKBONE_DEEP_DOORS_2_40_EPOCHS, EXP_GENERAL_DETECTOR_FIXED_BACKBONE_DEEP_DOORS_2_60_EPOCHS),
