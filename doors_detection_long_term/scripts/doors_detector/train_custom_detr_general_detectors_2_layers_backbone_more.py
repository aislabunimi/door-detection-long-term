...
starting_epoch = 60
model_names = [(EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_60_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_80_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_100_EPOCHS),
               (EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_DEEP_DOORS_2_60_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_DEEP_DOORS_2_80_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_DEEP_DOORS_2_100_EPOCHS),
               (EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_DEEP_DOORS_2_HALF_60_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_DEEP_DOORS_2_HALF_80_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_DEEP_DOORS_2_HALF_100_EPOCHS),
               (EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_DEEP_DOORS_2_60_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_DEEP_DOORS_2_80_EPOCHS, EXP_GENERAL_DETECTOR_2_LAYERS_BACKBONE_GIBSON_DEEP_DOORS_2_100_EPOCHS)]
...
def prepare_model(description, labels, reload_model, restart_checkpoint):
    ...
    return model, criterion, lr_scheduler, optimizer, logs, start_epoch
...
if __name__ == '__main__':
    ...
    for ((model_60_epochs, model_80_epochs, model_100_epochs), (train, validation, labels, _)) in zip(model_names, datasets):
        epoch_count = 0
        ...
        model, criterion, lr_scheduler, optimizer, logs, start_epoch = prepare_model(model_60_epochs, labels, reload_model=True, restart_checkpoint=True)
        model.set_description(model_80_epochs)
        print_logs_every = 10
        ...
        for epoch in range(start_epoch, epochs_general_detector[-1]):
            ...
            if epoch == epochs_general_detector[epoch_count] - 1 and epoch_count < len(epochs_general_detector) -1:
                epoch_count += 1
                model.set_description(model_100_epochs)