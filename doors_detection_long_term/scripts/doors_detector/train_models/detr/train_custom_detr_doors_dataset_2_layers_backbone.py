...
if __name__ == '__main__':
    ...
    for house in houses:
        ...
        model, criterion, lr_scheduler, optimizer, logs = prepare_model(globals()[f'EXP_1_{house}_2_LAYERS_BACKBONE_{epochs_general_detector[0]}_EPOCHS'.upper()], reload_model=False, restart_checkpoint=False)
    ...
    for house, epochs_general, quantity in [(h, e, q) for h in houses for e in epochs_general_detector for q in fine_tune_quantity]:
        if epochs_general == 40 and quantity == 15:
            continue
