...
for env in ['floor1', 'floor4', 'chemistry_floor0', 'house_matteo']:
    if not os.path.exists(os.path.dirname(__file__) + '/results/gibson_dd2_finetuned_hybrid/' + env):
        os.mkdir(os.path.dirname(__file__) + '/results/gibson_dd2_finetuned_hybrid/' + env)
