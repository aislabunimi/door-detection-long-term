...
dataset_loader_bboxes = DatasetLoaderBBoxes(folder_name='faster_rcnn_general_detector_gibson_dd2_floor1')
...
train_dataset_bboxes = DataLoader(train_bboxes[:100], batch_size=16, collate_fn=collate_fn_bboxes(use_confidence=True, image_grid_dimensions=grid_dim), num_workers=4, shuffle=True)
...
bbox_model.set_description(IMAGE_NETWORK_GEOMETRIC_BACKGROUND_HYBRID_HOUSE_MATTEO)
bbox_model.to('cuda')
