...
for model_name, dataset, epochs, in model_names_general_detectors:
    ...
    for house in houses:
        train, test, _, _ = get_final_doors_dataset_real_data(folder_name=f'{house}_evening', train_size=0.75, transform_train=False)
...
save_file(results, results_complete, 'yolov5_ap_real_data_different_condition.xlsx', 'yolov5_complete_metric_real_data_different_condition.xlsx')