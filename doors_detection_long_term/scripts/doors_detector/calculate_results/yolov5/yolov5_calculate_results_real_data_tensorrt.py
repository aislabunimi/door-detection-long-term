...
def compute_results(model_name, data_loader_test, description):
    ...
    model.eval()
    engine, context = model_to_tensorrt(model.model)
...
save_file(results, results_complete, 'yolov5_ap_real_data_tensorrt.xlsx', 'yolov5_complete_metric_real_data_tensorrt.xlsx')