...
def compute_results(model_name, data_loader_test, description, dataset=None):
    ...
    model = YOLOv5Model(model_name=YOLOv5, n_labels=2, pretrained=True, dataset_name=dataset_type, description=model_name)
    model.eval()
...
for model_name, dataset, epochs, in model_names_general_detectors:
    ...
    for house in houses:
        ...
        save_file(results, results_complete, 'yolov5_ap_real_data_onnx.xlsx', 'yolov5_complete_metric_real_data_onnx.xlsx')
