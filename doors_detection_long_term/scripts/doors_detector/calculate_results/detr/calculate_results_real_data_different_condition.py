...
save_file(results, results_complete, f'detr_ap_real_data_different_conditions_{str(iou_threshold)}.xlsx', f'detr_complete_metrics_real_data_different_conditions_{str(iou_threshold)}.xlsx')