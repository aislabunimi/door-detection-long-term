...
for house, dataset, epochs_gd in [(h, d, e) for h in houses for d in datasets for e in epochs_general_detector]:
    ...
    train, test, labels, COLORS = get_final_doors_dataset_real_data(folder_name=house + '_run2', train_size=0.75, transform_train=False)
...
save_file(results, results_complete, 'detr_ap_real_data_run2.xlsx', 'detr_complete_metrics_real_data_run2.xlsx')