...
from doors_detection_long_term.doors_detector.experiment_k.criterion import CriterionType, Criterion
...
for house in houses.keys():
    ...
    dataset_model_output = DatasetsCreatorExperimentK(
    ...
    final = '_experimentk_' + str(criterion_type) + '_' + str(threshold_criterion)
