...
# Hybrid
EXP_GENERAL_DETECTOR_HYBRID_FLOOR1_60_EPOCHS: DESCRIPTION = 382#331
EXP_GENERAL_DETECTOR_HYBRID_FLOOR4_60_EPOCHS: DESCRIPTION = 383#332
EXP_GENERAL_DETECTOR_HYBRID_CHEMISTRY_FLOOR0_60_EPOCHS: DESCRIPTION = 384#333
EXP_GENERAL_DETECTOR_HYBRID_HOUSE_MATTEO_60_EPOCHS: DESCRIPTION = 385#334
...
class FasterRCNN(GenericModel):
    def __init__(self, model_name: ModelName, n_labels: int, pretrained: bool, dataset_name: DATASET, description: DESCRIPTION, box_score_thresh=0.05, box_nms_thresh=0.5, box_detections_per_img=100):
        ...
        self.model = torchvision.models.detection.fasterrcnn_resnet50_fpn(pretrained=True, box_score_thresh=box_score_thresh, box_nms_thresh=box_nms_thresh, box_detections_per_img=box_detections_per_img)
