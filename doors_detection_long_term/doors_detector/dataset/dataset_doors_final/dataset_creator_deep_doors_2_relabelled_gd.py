...
class DatasetsCreatorDeepDoors2LabelledGD:
    ...
    def creates_dataset(self, random_state: int = 42):
        ...
        return (
            DatasetDoorsFinalAndDeepDoors2('', self._dataset_path, train_dataframe, TRAIN_SET, std_size=256, max_size=800, scales=[256 + i * 32 for i in range(11)]),
            DatasetDoorsFinalAndDeepDoors2('', self._dataset_path, validation_dataframe, TEST_SET, std_size=256, max_size=800, scales=[480 + i * 32 for i in range(11)])
        )
